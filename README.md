...
## Why?
JavaScript was originally as a scripting language to do simple manipulations on the DOM node tree. Core JavaScript in the early days was fairly difficult to use, so jQuery emerged as the de facto way to write JavaScript. 
